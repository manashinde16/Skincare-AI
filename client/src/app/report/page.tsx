...
export default function ReportPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-8 font-sans relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl p-6 md:p-10 lg:p-12 relative z-10">
        {/* Enhanced Header */}
          ...
          <>
            ...
            <section className="mb-10 text-center">
              ...
              <Card className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl border border-purple-100 shadow-lg max-w-3xl mx-auto">
                <CardContent className="p-8 text-lg text-gray-700 leading-relaxed">
                  {reportContent.analysis}
                </CardContent>
              </Card>
            </section>
                        ...
                        <Card key={`morning-step-${stepIndex}-opt-${idx}`} className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                          <CardContent className="p-4 flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              <h4 className="text-base font-semibold text-gray-800 mb-2">{product.name}</h4>
                              <p className="text-sm text-gray-600 mb-2"><span className="font-medium">How to use:</span> {product.usage}</p>
                              <p className="text-xs text-gray-500 mb-3"><span className="font-medium">Key Ingredients:</span> {product.ingredients.join(", ")}</p>
                              <div>
        ...
        {/* Footer */}
        <div className="text-center mt-12 p-8 bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl border border-gray-200">
